...
* @returns {Uint8Array}
*/
export function ctr128(plaintext, key, iv) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(plaintext, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        ...
        var ptr2 = passArray8ToWasm0(iv, wasm.__wbindgen_malloc);
        var len2 = WASM_VECTOR_LEN;
        wasm.ctr128(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v3 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
* @returns {Uint8Array}
*/
export function ctr192(plaintext, key, iv) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(plaintext, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        ...
        var ptr2 = passArray8ToWasm0(iv, wasm.__wbindgen_malloc);
        var len2 = WASM_VECTOR_LEN;
        wasm.ctr192(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v3 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
* @returns {Uint8Array}
*/
export function ctr256(plaintext, key, iv) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(plaintext, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        ...
        var ptr2 = passArray8ToWasm0(iv, wasm.__wbindgen_malloc);
        var len2 = WASM_VECTOR_LEN;
        wasm.ctr256(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v3 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
